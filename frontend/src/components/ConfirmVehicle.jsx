...
const ConfirmVehicle = (props) => {
  return (
    <div>
      ...
      <h3 className="text-2xl font-semibold text-center py-4">Confirm your Ride</h3>
      ...
      <button onClick={()=>{
        ...
        props.setConfirmRidePannel(false)
      }} className='w-[80%] bg-green-600 text-lg text-white py-3 mt-4 mb-2 rounded-full'>Confirm</button>
      </div>
    </div>
  )
}
